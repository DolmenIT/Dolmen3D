...
export class d3d_monitor {
    constructor() {
        ...
        this.d3d_monitor_div.style.top = '0';
        this.d3d_monitor_div.style.left = '90vw';
        this.d3d_monitor_div.style.width = '10vw';
        this.d3d_monitor_div.style.height = '5vw';
        this.d3d_monitor_div.style.color = 'white';
        this.d3d_monitor_div.style.backgroundColor = 'hsla(210,75%,25%,0.25)';
