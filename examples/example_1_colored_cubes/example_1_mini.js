...
d3d.scenes.addObjects({
    "objCubeRed": d3d.geometry.cube({
        center: [0, 0, 0], size: [ 1, 1, 1 ], material: "basicRed"
    }),
    "objCubeYellow": d3d.geometry.cube({
        center: [1.5, 0, 0], size: [ 1, 1, 1 ], material: "basicYellow"
    }),
    "objCubeGreen": d3d.geometry.cube({
        center: [3, 0, 0], size: [ 1, 1, 1 ], material: "basicGreen"
    }),
    "objCubeTeal": d3d.geometry.cube({
        center: [4.5, 0, 0], size: [ 1, 1, 1 ], material: "basicTeal"
    }),
    "objCubeBlue": d3d.geometry.cube({
        center: [6, 0, 0], size: [ 1, 1, 1 ], material: "basicBlue"
    }),
