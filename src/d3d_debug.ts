...
export class d3d_debug {
    ...
    constructor() {
        ...
        this.d3dDebugDiv.style.top = '0';  // Optionnel : Définir la position depuis le haut
        this.d3dDebugDiv.style.left = '0';  // Optionnel : Définir la position depuis la gauche
        this.d3dDebugDiv.style.width = 'calc(100vw / 3)';  // Optionnel : Définir la position depuis la gauche
        this.d3dDebugDiv.style.height = '100vh';  // Optionnel : Définir la position depuis la gauche
        this.d3dDebugDiv.style.color = 'white';  // Texte blanc
        this.d3dDebugDiv.style.backgroundColor = 'hsla(210,75%,25%,0.25)';  // Fond rouge foncé
